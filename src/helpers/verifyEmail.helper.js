    ...
    try {
        const htmlContent = `
            ...
            <div class="container" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                <h1 style="color: #4a4a4a; font-size: 24px; margin-bottom: 20px;">Código de verificación de cuenta: <strong style="color: #4a4a4a;">${verifyCode}</strong></h1>
                <p style="margin-bottom: 15px;">Haz clic en el siguiente enlace para verificar tu cuenta:</p>
