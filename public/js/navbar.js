    ...
    try {
        ...
        if(!cookieU){
            ...
            optsUser.innerHTML = `
                ...
                <li><button class="bg-gray-400 cursor-pointer hover:bg-gray-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" id="signout">Signout</button></li>
            `
